...
public class HinhTronServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>"+"Kết Quả Của Hình Tròn có bán kín bằng "+bk+" là:" +"</h1>");
            out.println("<ul>");
            out.println("<li>"+"<h4>"+"Chu vi hình tròn bằng:"+cv+"</h4>"+"</li>");
            out.println("<li>"+"<h4>"+"Diện Tích hình tròn bằng:"+dt+"</h4>"+"</li>");
            out.println("</ol>");
            out.println("</body>");
            out.println("</html>");
        }
